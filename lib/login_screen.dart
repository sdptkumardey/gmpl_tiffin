...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _checkIp() async {
    ...
    final ip = prefs.getString('ip');
    setState(() {
      _isIpSet = ip != null && ip.isNotEmpty;
      _ip = ip ?? '';
    });
  }
    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: [
            Image.asset('images/logo.png', width: 240),
            ...
            if (_isIpSet) ...[
              ...
              const Text('Please set IP address to continue.',
                  style: TextStyle(fontSize: 18, color: Color(0XFF7b1a4f))),
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  ...
                  label: const Text('Set IP', style: TextStyle(color: Colors.white)),
                  style: ElevatedButton.styleFrom(
                    backgroundColor: const Color(0xFF600d41),
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(30),
                  ...
                  onPressed: () async {
                    await Navigator.of(context).push(
                      MaterialPageRoute(builder: (_) => SetIpPage()),
                    );
                    _checkIp(); // Check again after returning from SetIpPage
                  },
                ),
              ),
            ],
